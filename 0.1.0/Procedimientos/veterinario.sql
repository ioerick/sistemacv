...
insert into historial_actividades (accion, usuario, tabla, campo) values ('add', user, 'veterinario', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('edit', user, 'veterinario', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('delete', user, 'veterinario', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('search', user, 'veterinario', pk);
end;
$body$
language plpgsql;
