...
insert into historial_actividades (accion, usuario, tabla, campo) values ('add', user, 'direccion', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('edit', user, 'direccion', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('delete', user, 'direccion', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('search', user, 'direccion', pk);
end;
$body$
language plpgsql;
