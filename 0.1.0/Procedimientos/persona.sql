...
insert into historial_actividades (accion, usuario, tabla, campo) values ('add', user, 'persona', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('edit', user, 'persona', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('delete', user, 'persona', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('search', user, 'persona', pk);
end;
$body$
language plpgsql;
