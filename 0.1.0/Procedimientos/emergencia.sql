...
insert into historial_actividades (accion, usuario, tabla, campo) values ('add', user, 'emergencia', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('edit', user, 'emergencia', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('delete', user, 'emergencia', pk);
end;
$body$
language plpgsql;
...
insert into historial_actividades (accion, usuario, tabla, campo) values ('search', user, 'emergencia', pk);
end;
$body$
language plpgsql;
